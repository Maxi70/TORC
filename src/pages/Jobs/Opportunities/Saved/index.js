...
export default function JobsSaved() {
  ...
  if (!jobOpp) history.replace(`/jobs/opportunities`);
    ...
    <div className="flex flex-col h-screen">
      ...
      <JobPageWrapper>
        <div className="max-w-4xl mx-auto py-24 px-3 flex flex-col gap-4">
          <p className="md:text-5xl text-4xl font-nexa">
            Your job post {jobOpp.title && `for ${jobOpp.title} `}has been
            saved!
          </p>
          <p className="font-nexa text-lg mt-2">
            It is safe and sound on your My Jobs page. From there, you can edit
            or activate this job, as well as view the status of your other jobs
          </p>
        </div>
